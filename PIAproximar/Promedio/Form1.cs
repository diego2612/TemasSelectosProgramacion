    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            for (int i=0;i<arreglo.Length;i++)
            {
                ...
                GraficarEstadistica.Series["Media + STD"].Points.AddXY(i, estadistico.Mean(arreglo) + estadistico.DesviacionEstandarS(arreglo));
                GraficarEstadistica.Series["Media + 2*STD"].Points.AddXY(i, estadistico.Mean(arreglo) + 2 * estadistico.DesviacionEstandarS(arreglo));
                GraficarEstadistica.Series["Media - STD"].Points.AddXY(i, estadistico.Mean(arreglo) - estadistico.DesviacionEstandarS(arreglo));
                GraficarEstadistica.Series["Media - 2*STD"].Points.AddXY(i, estadistico.Mean(arreglo) - 2 * estadistico.DesviacionEstandarS(arreglo));
